...
use gg_renderer::Font;
use gg_renderer::SceneCamera;
use gg_renderer::Texture2D;
use crate::native_script::NativeScript;
use gg_core::uuid::Uuid;
use gg_core::Ref;
...
pub struct NativeScriptComponent {
    pub instance: Option<Box<dyn NativeScript>>,
    pub instantiate_fn: fn() -> Box<dyn NativeScript>,
    pub created: bool,
}
...
impl RigidBodyType {
    pub fn to_rapier_2d(self) -> rapier2d::dynamics::RigidBodyType {
        match self {
    ...
    pub fn to_rapier_3d(self) -> rapier3d::dynamics::RigidBodyType {
        match self {
...
pub struct RigidBody2DComponent {
    ...
    pub runtime_body: Option<rapier2d::dynamics::RigidBodyHandle>,
}
...
pub struct BoxCollider2DComponent {
    ...
    pub is_sensor: bool,
    /// Runtime-only handle into the physics world. Not serialized.
    pub runtime_fixture: Option<rapier2d::geometry::ColliderHandle>,
}
...
pub struct RigidBody3DComponent {
    ...
    pub angular_damping: f32,
    /// Runtime-only handle into the physics world. Not serialized.
    pub runtime_body: Option<rapier3d::dynamics::RigidBodyHandle>,
}
...
pub struct BoxCollider3DComponent {
    ...
    pub is_sensor: bool,
    /// Runtime-only handle into the physics world. Not serialized.
    pub runtime_fixture: Option<rapier3d::geometry::ColliderHandle>,
}
...
pub struct AudioSourceComponent {
    ...
    /// 0 = no audio assigned.
    pub audio_handle: gg_core::uuid::Uuid,
...
impl Default for AudioSourceComponent {
    fn default() -> Self {
        Self {
            audio_handle: gg_core::uuid::Uuid::from_raw(0),
            volume: 1.0,
            pitch: 1.0,
            looping: false,
            play_on_start: false,
...
pub struct TilemapComponent {
    ...
    pub texture_handle: gg_core::uuid::Uuid,
    /// Runtime-only loaded texture. Not serialized.
    pub texture: Option<Ref<gg_renderer::Texture2D>>,
...
impl Default for TilemapComponent {
    fn default() -> Self {
        Self {
            ...
            texture_handle: gg_core::uuid::Uuid::from_raw(0),
            texture: None,
            tileset_columns: 1,
...
pub struct MeshRendererComponent {
    ...
    pub loaded_mesh: Option<Ref<gg_renderer::Mesh>>,
    ...
    pub vertex_array: Option<gg_renderer::VertexArray>,
}
...
pub struct SkeletalAnimationComponent {
    ...
    pub mesh_asset: gg_core::uuid::Uuid,
    /// Shared skeleton (joint hierarchy + inverse-bind matrices).
    pub skeleton: gg_core::Ref<gg_renderer::skeleton::Skeleton>,
    /// Shared animation clips extracted from the glTF asset.
    pub clips: Vec<gg_renderer::skeleton::SkeletalAnimationClip>,
    ...
    pub clip_events:
        std::collections::HashMap<String, Vec<gg_renderer::skeleton::SkeletalAnimationEvent>>,

    /// Runtime-only: the uploaded skinned mesh vertex array.
    pub skinned_vertex_array: Option<gg_renderer::VertexArray>,
    /// Runtime-only: the loaded skinned mesh data (shared via Arc).
    pub loaded_skinned_mesh: Option<gg_core::Ref<gg_renderer::SkinnedMesh>>,
}
...
impl SkeletalAnimationComponent {
    ...
    pub fn from_gltf_skin_data(data: &gg_renderer::GltfSkinData) -> Self {
        Self {
            mesh_asset: gg_core::uuid::Uuid::from_raw(0),
            skeleton: gg_core::Ref::new(data.skeleton.clone()),
            ...
            loaded_skinned_mesh: Some(gg_core::Ref::new(data.mesh.clone())),
        }
    }

    /// Create a stub component from an asset handle. The skeleton, clips,
    /// and mesh data will be populated later by asset resolution.
    pub fn from_asset(handle: gg_core::uuid::Uuid) -> Self {
        use gg_renderer::skeleton::Skeleton;
        Self {
            mesh_asset: handle,
            skeleton: gg_core::Ref::new(Skeleton {
                joint_names: Vec::new(),
    ...
    pub fn compute_current_pose(&self) -> gg_renderer::skeleton::BonePose {
        use gg_renderer::skeleton::BonePose;
