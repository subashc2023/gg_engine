...
impl Scene {
    ...
    pub fn on_audio_start(&mut self) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_audio_start");
    ...
    pub fn resolve_audio_handles(&mut self, asset_manager: &mut gg_assets::EditorAssetManager) {
        let needs_resolve: Vec<(hecs::Entity, gg_core::uuid::Uuid)> = self
            .world
    ...
    pub fn find_asset_references(
        &self,
        asset_handle: gg_core::uuid::Uuid,
    ...
    pub fn dispatch_sound_finished_events(&mut self) {
