...
impl Scene {
    ...
    pub fn on_lua_scripting_start(&mut self) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_lua_scripting_start");
    ...
    pub fn on_lua_scripting_stop(&mut self) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_lua_scripting_stop");
    ...
    pub fn on_update_lua_scripts(&mut self, dt: Timestep, input: &Input) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_update_lua_scripts");
