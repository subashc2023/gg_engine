...
impl Scene {
    ...
    pub fn on_runtime_start(&mut self) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_runtime_start");
    ...
    pub fn on_runtime_stop(&mut self) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_runtime_stop");
        self.on_audio_stop();
    ...
    pub fn on_update_all_physics(&mut self, dt: Timestep, input: Option<&Input>) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_update_all_physics");
    ...
    pub fn dispatch_collision_events_3d(&mut self) {
    ...
    #[cfg(feature = "lua-scripting")]
    pub fn call_lua_fixed_update(&mut self, fixed_dt: f32, input: &Input) {
        use super::script_glue::SceneScriptContext;
        #[cfg(feature = "lua-scripting")]
    ...
    #[cfg(feature = "lua-scripting")]
    pub fn dispatch_collision_events(&mut self) {
    ...
    pub fn on_update_scripts(&mut self, dt: Timestep, input: &Input) {
        let _timer = gg_core::profiling::ProfileTimer::new("Scene::on_update_scripts");
    ...
    pub fn run_native_fixed_update(&mut self, dt: Timestep, input: &Input) {
        self.run_native_scripts(dt, input, |inst, entity, scene, dt, input| {
