...
pub(crate) fn draw_box_collider2d_component(
    ...
    super::component_header(ui, "Box Collider 2D", "box_collider_2d", bold_family, entity, |ui| {
        let (
            mut offset,
            mut size,
            mut density,
...
pub(crate) fn draw_circle_collider2d_component(
    ...
    super::component_header(ui, "Circle Collider 2D", "circle_collider_2d", bold_family, entity, |ui| {
        let (
            mut offset,
            mut radius,
            mut density,
