...
use gg_core::events::{Event, KeyCode, MouseButton, MouseEvent};
...
impl EditorCamera {
    ...
    pub fn on_update(&mut self, dt: gg_core::Timestep, input: &Input) {
    ...
    fn update_projection(&mut self) {
        ...
        self.projection.w_axis.z =
            self.near_clip * self.far_clip / (self.far_clip - self.near_clip);
